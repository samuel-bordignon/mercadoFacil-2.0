...
function PerfilCliente() {  // Função que define o componente PerfilCliente
  ...
  const handleDeleteAccount = async () => {
    try {
      const success = await deleteData('clientes', idCliente)  // Exclui os dados do cliente do banco
      if (success) {
        toast.success('Conta excluída com sucesso! Esperamos te ver novamente em breve.')  // Notificação de sucesso
