...
function Navbar() {
  ...
  const [activeAdderes, setActiveAdderes] = useState(null)
  ...
  const [produtosdb, setProdutosdb] = useState([
    ...
    },
    {
      ...
      informacaoAdicional: { peso: null, unidade: "1" }
    },
    {
      id: 5,
  ...
  const [listaComprasNavdb, setListaComprasNavdb] = useState(
    {id: 1, nome: "Lista 1", produtos: null },
  )
  const [mercadosdb, setMercadosdb] = useState([
    ...
    { id: 3, nome: "Mercado do Pedro", endereco: "Rua das Oliveiras, 789", cep: "88058087", logo: "3.png", atual: false },
  ])
  ...
  const toggleAdderess = (cep) => {
    if (activeAdderes === cep) {
      return
    } else {
      setActiveAdderes(cep)
      ...
      <div id="container-direito-nav">
        ...
        {activePopup === 'address' && (
          <div onClick={() => { setActivePopup(null) }} className="overlay">
            <div className="popup-address" onClick={(e) => e.stopPropagation()}>
              ...
              <button className="add-adderress">
                <div>
              ...
              {enderecosdb.map((endereco) => (
                <button
                  key={endereco.id}
                  className={activeAdderes === endereco.cep || endereco.atual ? 'adderess-um-atual' : 'adderess'}
        ...
        <div id="user-list-container">
          ...
          {activePopup === 'list' && (
            <div onClick={() => { setActivePopup(null) }} className="overlay">
              <div className="popup-list" onClick={(e) => e.stopPropagation()}>
                <button
                  className="btn-popup"
                  onClick={() => { setActivePopup(null) }}
                >
                  ...
                  {mercadosdb.map((mercado) => {
                    if (mercado.atual === 'oi') {
                      return <div key={mercado.id} className="market-list">
                        ...
                        <NavLink to="/mercado" className="change-market">Ver Catálogo</NavLink>
                      </div>
                    }
                  })}
                ...
                <div className="total-container">
                  ...
                  <div className="total-btns">
                    ...
                    <button className="enviar-btn" onClick={customImageToast}>
                      Enviar Lista
                    </button>
                  </div>
                </div>
